...
uWidgets, the project this follows, is CC BY-NC-SA 4.0. uMedia is a separate
implementation written against its documented plugin API and conventions rather than
a copy of its source — worth keeping in mind if you publish anything derived from both.
